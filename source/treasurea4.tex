...
\newcommand{\longyoho}{
\settowidth{\versewidth}{Drink and the devil had done for the rest---}
\begin{verse}[\versewidth]
\begin{altverse}
Fifteen men on the dead man’s chest---\\
Yo-ho-ho, and a bottle of rum!\\
...
\headheight=45pt
 ...
 \begin{figure}[p!]
\centering
\includegraphics[width=\linewidth]{frontispiece}
...
\headsep=0pt
 \begin{figure}[p!]
\centering
\includegraphics[width=.95\linewidth]{timapcolor}
\caption[Map]{}
\end{figure}
%\vfill
\thispagestyle{empty}
...
\footskip=20pt
\renewcommand{\contentsname}{\includegraphics[width=\linewidth]{contents}\vspace{-0.5cm}}
\tableofcontents
%\clearpage
...
\renewcommand{\listfigurename}{\includegraphics[width=\linewidth]{listofillustrations}\vspace{-0.5cm}}
\listoffigures
...
~\\
~\\
\lettrine[lines=4,image=true]{chap9initT}{o} Lloyd Osbourne, an American gentleman in accordance with whose classic taste the following narrative has been designed, it is now, in return for numerous delightful hours, and with the kindest wishes, dedicated by his affectionate friend,
\begin{flushright}
\textsc{the author.}
\end{flushright}
\clearpage
